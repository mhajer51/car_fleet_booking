...
Route::prefix('admin')->name('api.admin.')->group(function (): void {
    ...
    Route::prefix('cars')->group(function (): void {
        Route::get('/', [AdminCarController::class, 'index'])
            ->name('cars.index');
        Route::post('/', [AdminCarController::class, 'store'])
            ->name('cars.store');
        Route::put('{car}', [AdminCarController::class, 'update'])
            ->name('cars.update');
        Route::patch('{car}/status', [AdminCarController::class, 'updateStatus'])
